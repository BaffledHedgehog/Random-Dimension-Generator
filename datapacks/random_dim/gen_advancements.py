try:
    from gen_lore import generate_lore_40_words
except ImportError:
    def generate_lore_40_words(rng):
        return "Призрачный хронометр беззвучно растворял перламутровые траектории забытого ветра среди хрустальных лабиринтов, пока созвездия неустанно чертили круги над бездной, увлекая дремлющие тени навстречу сиянию вечности под тихим взором мерцающей полночи."
...
NONSENSE_100_WORDS = [
    'Призрачный хронометр беззвучно растворял перламутровые траектории забытого ветра среди хрустальных лабиринтов вечерней зари, пока древний коловорот созвездий неустанно нанизывал изумрудные отголоски бытия на невидимые нити зыбкого пространства, увлекая дремлющие тени сквозь мерцающую вуаль туманных раздумий в бескрайние пределы иллюзорной тишины, где бархатные волны шепчущего эфира омывали гранитные уступы парящих островов, рождая причудливые узоры несбыточных снов, отягощенных глубоким дыханием полуночных зеркал, в которых тайком отражался задумчивый странник, перебирающий сверкающие осколки вечности тонкими пальцами, не ведающими усталости или сомнений, навстречу торжественному шествию пурпурных комет, озаряющих молчаливый покой мироздания величавой вспышкой неугасимого пламени, хранящего неизреченную мудрость угасающих эпох под куполом неведомой рассветной гармонии.',
    'Бесшумный механизм хрустального маятника неумолимо раскручивал изумрудные спирали полузабытого мифа вдоль пурпурных аллей дремлющего сада, пока серебристый вихрь неведомых мыслей осторожно рассыпал алмазную пыльцу по гладким плитам древней террасы, пробуждая уснувшие тени величавых башен, которые гордо вздымались сквозь сиреневую дымку вечернего безмолвия к сияющим вершинам недосягаемых облаков, где лазурные птицы неустанно чертили геометрические траектории бытия над бескрайними просторами шепчущего океана, хранящего в своих таинственных глубинах перламутровые осколки рухнувших созвездий, оставленных одиноким хранителем времени ради торжественного ритуала неизбежного возрождения под тихим взором мерцающей полночи, окутавшей дремучие леса своим невесомым покрывалом из тончайших нитей призрачной лунной симфонии вопреки всем законам угасающей реальности.',
    'Задумчивый алхимик неспешно переливал сияющий эликсир полуденного жара в мраморный сосуд незыблемого покоя, когда внезапный порыв студеного северного дыхания потревожил золотые страницы ветхого фолианта, исписанного причудливыми символами забытых цивилизаций, стремящихся отыскать утраченный ключ от великих врат бесконечности, где глубокие реки жидкого янтаря неторопливо несли свои тягучие воды сквозь гранитные арки колоссального акведука, возведенного могучими титанами на рассвете первых столетий мироздания ради спасения хрупкого равновесия между пылающими искрами первозданного хаоса и ледяной твердью вечной ночи, неумолимо наступающей на хрупкие берега надежды, озаряемые лишь тусклым мерцанием одиноких маяков, возвышающихся над бушующей стихией во имя торжества великой рассветной мудрости сквозь непроницаемую мглу веков.'
]
    ...
    for seed in range(1, seeds + 1):
        with tempfile.TemporaryDirectory() as td:
            ...
            for i, nm in enumerate(names):
                ...
                assert 30 <= len(vis_desc.split()) <= 48, (nm, len(vis_desc.split()), vis_desc)
